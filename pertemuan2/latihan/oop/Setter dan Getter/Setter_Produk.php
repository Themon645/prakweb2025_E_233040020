...
class produk {
  ...
  // membuat method setter untuk melakukan perubahan pada properti protected/private
...
class game extends produk {
  ...
  echo $produk1->getInfoProduk(); // komik : Goku | Masashi Kishimoto, Shonen Jump (Rp. 30000) - 100 Halaman.

  // ini getter
  // memanggil getJudul dari child class
